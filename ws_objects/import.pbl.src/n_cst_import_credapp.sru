...
for li_cnt = 1 to upperbound(il_ocr_pracid)	
	...
	insert into pd_images(image_type_id, prac_id, seq_no, rec_id, facility_id, screen_id,reference_name, active_status, num_pages, tif_start_page, de_queue, user_name, date_scanned)
		values(-1, :ll_prac_id, :ll_seq_no, :ll_rec_id, :li_facility_id, 1, 'Release Form', 1, :ai_page, 1, 0, :gs_user_id, :ldt_date) using sqlca;		

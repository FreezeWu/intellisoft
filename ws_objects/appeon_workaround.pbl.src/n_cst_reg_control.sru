...
String Is_WebComponents = "WebComponents_V151.exe" //alfee 11.18.2015
...
Else
	...
	choose case ai_control
		...
		case 4 //Image Viewer CP OCXs
			...
			ls_Key_OCXs_urp[1] = ""
			ls_Key_OCXs_urp[2] = "HKEY_CLASSES_ROOT\TypeLib\{C08027D6-71EE-4936-AC1F-3F188E8889A3}\1.0\0\win32"
			ls_Key_OCXs_urp[3] = ""
			//---------End Added ------------------------------------------------------
			...
			//ll_file_size[2] = 1798144 //4.6		
			ll_file_size[1] = 2658304 //10.0
			ll_file_size[2] = 1789952 //5.5
			ll_file_size[3] = 937984	//7.2.0.1
			//---------End Modfiied ------------------------------------------------------
			...
			For i = 1 To Upperbound(ls_Key_OCXs[])	
				...
				If appeongetclienttype () = "WEB" And i = 1 And ( isnull(ls_return ) Or trim(ls_return) = '' ) Then //(Appeon)Alfee 07.19.2013 - V141 ISG-CLX		
					...
					//---------End Modfiied ------------------------------------------------------
					*/
					ll_dll_size[1]	=	2921472
					ll_dll_size[2]	= 282624
					ll_dll_size[3]	= 1880576
					ll_dll_size[4]	= 792064 
					ll_dll_size[5]	=  687104
					//---------End Modfiied ------------------------------------------------------

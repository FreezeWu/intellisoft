...
String gs_current_version = '153' //for DB Upgrade,keep it updated
String gs_current_version_patch = '004' //for DB Upgrade, keep it updated 
...
IF gb_sk_ver then  
	w_mdi.Title = "IntelliApp Smart 15.3" //Kenetics"
	ls_app = "IntelliApp Smart 15.3" //Kenetics"
ElseIF Upper( gs_cust_type ) = 'I' THEN
	w_mdi.Title = "IntelliApp 15.3"
	ls_app = "IntelliApp 15.3"
ELSEIF gb_contract_version = True THEN
	w_mdi.Title = "IntelliContract 15.3"
	ls_app = "IntelliContract 15.3"
ELSE
	w_mdi.Title = "IntelliCred 15.3"
	ls_app = "IntelliCred 15.3"
END IF

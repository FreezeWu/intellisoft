...
type st_1 from statictext within w_lookup_maint
end type
...
this.Control[iCurrent+11]=this.dw_name
this.Control[iCurrent+12]=this.cb_new_lookup
...
this.Control[iCurrent+18]=this.cb_filter
this.Control[iCurrent+19]=this.cb_print
this.Control[iCurrent+20]=this.cb_saveas
this.Control[iCurrent+21]=this.cb_test
this.Control[iCurrent+22]=this.dw_users
this.Control[iCurrent+23]=this.cb_1
this.Control[iCurrent+24]=this.cb_letterstorage
this.Control[iCurrent+25]=this.dw_record
this.Control[iCurrent+26]=this.dw_detail

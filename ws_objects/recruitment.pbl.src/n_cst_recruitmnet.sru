...
for li_cnt = 1 to ids_image_type.rowcount()
	...
	if ll_doc_rec > 0 then
		...
		insert into pd_images(prac_id, seq_no, rec_id, screen_id, active_status, image_type_id, facility_id, user_name, date_recieved, tif_start_page, file_name)
		values(:al_prac_id, 1, :al_rec_id, :ai_screen, 1, :li_image_type, 1, :gs_user_id, :ldt_date, 1, :ls_filename );

...
//debugbreak()		
		...
		if w_mdi.of_security_access(50) = 1 then //read only
			...
			if gb_sk_ver then   //Start Code Change ----05.08.2012 #V12 maha - exception for smart
				...
				of_buttons_visible( True,  True,   True,  True,  True,  True, False,  True,  True, True,  False,  False)
...
this.backColor = rgb(240, 243, 244)
...
event constructor;if gs_cust_type = 'I' then
...
// RP
this.object.datawindow.color = rgb(240, 243, 244)

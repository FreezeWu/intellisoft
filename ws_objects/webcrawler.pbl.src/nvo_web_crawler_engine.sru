...
FOR i = ai_start TO ai_end
	...
	CHOOSE CASE ls_step_action
		...
		CASE "Save Page as Image"	
			...
			ls_tag = "SAVEAS TYPE=HTM FOLDER=" + ls_crawl_path + " FILE=_ResultPage.htm"
			FileWrite( li_FileNum, ls_tag  )	
		CASE "Save Page as PDF"	  //Start Code Change ----12.16.2016 #V153 maha - added
			...
			ls_file_type = "pdf"
			ii_type = 2  //Start Code Change ----04.29.2016 #V15 maha
			ib_image_saved = True
			is_saved_file = ls_path + "_ResultPage.pdf"
			ls_tag = "SAVEAS TYPE=PDF FOLDER=" + ls_crawl_path + " FILE=_ResultPage.pdf"
			FileWrite( li_FileNum, ls_tag  )								
			ls_tag = "SAVEAS TYPE=HTM FOLDER=" + ls_crawl_path + " FILE=_ResultPage.htm"
			FileWrite( li_FileNum, ls_tag  )	

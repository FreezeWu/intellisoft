...
this.Control[iCurrent+2]=this.cb_selecttab2
this.Control[iCurrent+3]=this.dw_facility_add
this.Control[iCurrent+4]=this.dw_entity_add
this.Control[iCurrent+5]=this.cb_find_gp
this.Control[iCurrent+6]=this.cb_prior
this.Control[iCurrent+7]=this.cb_next
this.Control[iCurrent+8]=this.cb_add_gp
...
this.Control[iCurrent+13]=this.cb_viewdoc
this.Control[iCurrent+14]=this.cb_addfor
this.Control[iCurrent+15]=this.st_buttons
end on
...
//li_mgp_id = ii_mgp_id
//of_group_link_local(li_loc_id)
//of_group_link_local(li_loc_id, false) //alfee 11.11.2010

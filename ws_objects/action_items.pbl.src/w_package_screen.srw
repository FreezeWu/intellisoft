...
public function integer of_zip_package (long al_prac_id)
...
if li_app_chx = 1 then 
	...
	if not isnull(ll_app_id) then dw_1.setitem(1,"app_id", ll_app_id)
else
...
ls_file_name =  gs_temp_path + "packagezip\app_"+ String(al_prac_id) + "_"  + String(al_app_id) + ls_file_ext
//---------End Modified ------------------------------------------------------
...
ls_file_name =  gs_temp_path + "packagezip\prf_Profile.pdf"
...
ls_file_name =  gs_temp_path + "packagezip\vprf_Profile.pdf"
li_Return = inv_pdf.of_Print(dw_profile, ls_file_name)
...
ls_file_name =  gs_temp_path + "packagezip\chklst_report.pdf"
li_Return = inv_pdf.of_Print(dw_profile, ls_file_name)
...
for li_cr  = 1 to ids_image.rowcount()
	...
	if li_status = 1 and (li_facility_id = ii_facility_id or li_facility_id = 0) and (ai_img_type = 0 or li_type = 99) then
		...
		yield()
		ls_file = gs_temp_path + "images\" + String(al_prac_id) + "_" + String(ll_seq_no) + ".tif"
		...
		if li_type = 99 then
			ls_img ='verif_' + mid(ls_file, lastpos(ls_file, '\') + 1)
		else
			ls_img ='img_' + mid(ls_file, lastpos(ls_file, '\') + 1)
		end if				
...
if not fileexists(gs_dllocx_path+"7z.dll") then
	messagebox("Prompt", "The file " + gs_dllocx_path + "7z.dll is not existed !"+&
...
ls_attach = gs_temp_path + "packagezip\" + "package_" + string(al_prac_id) +".zip"

if not FileExists(ls_attach) then
	MessageBox("Prompt", "Zip package process failed, please retry." )
	return -1
end if
...
this.Control[iCurrent+1]=this.cb_checktest
this.Control[iCurrent+2]=this.ole_scan_edit
...
this.Control[iCurrent+20]=this.mle_cover_text
...
this.Control[iCurrent+25]=this.dw_facility
this.Control[iCurrent+26]=this.ole_admin
this.Control[iCurrent+27]=this.ole_mail
end on
...
for li_i = 1 to upperbound(il_prac_ids)
	...
	//---------Begin Modified by (Appeon)Stephen 10.21.2013 for BugA101704--------
	//if isvalid(w_appeon_gifofwait) then close(w_appeon_gifofwait)
	//openwithparm( w_appeon_gifofwait, "Creating zip package,  Please wait..." )
	w_package_gifofwait.st_1.text = "Creating zip package, Please wait..."
	w_package_gifofwait.hpb_1.Position = 80
	w_package_gifofwait.BringToTop = TRUE
	//---------End Modfiied ------------------------------------------------------
	if of_zip_package(il_prac_ids[li_i]) = -1 then 
		lb_failed = True //Added by Appeon long.zhang 01.18.2017 (Case #000068546 What is this error please)
		exit
	End If
	yield()
...


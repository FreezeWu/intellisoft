...
choose case mret 
        ...
        case mailReturnSuccess! 
				...
				inv_EmailLog.of_SaveSentItem(gs_user_id,as_Subject,"",as_email_address, as_email_cc, "",ls_AttachmentName,2,2,lblb_MailContent) //modify by stephen 05.08.2013 - add email cc
				//---------- APPEON END ------------
        case else 
                ls_message = 'Other' 
end choose 

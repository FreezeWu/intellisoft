...
/* R.Avital v11.3 Add update to verif_info table
	create_date/create_user or mod_date/mod_user
	on any update to the table
	Begin changes
*/
...
//Start Code Change ----10.01.2012 #V12 maha - removed as redundant
//// R.Avital v11.3 added update of create/modify user and date
//// Incorporated into existing code for update of exp.date and ref.value
//// Begin changes
//SELECT create_user INTO :ls_user FROM verif_info
//WHERE ( verif_info.rec_id = :ll_rec_id ) AND ( verif_info.active_status = 1 )
//USING SQLCA;
//
...
//		 create_date = :ldt_date,
//		 create_user = :gs_user_id
//	WHERE ( verif_info.rec_id = :ll_rec_id ) AND ( verif_info.active_status = 1 )
//	USING SQLCA;
//ELSEIF IsNull(ls_user) OR Trim(ls_user) = '' THEN
//	UPDATE verif_info  
//	SET reference_value = :ls_reference,   
//   	 expiration_date = :ldt_exp_date,
//		 mod_date = :ldt_date,
...
borderstyle borderstyle = stylelowered!
integer itempictureindex[] = {1,0,0,0,0,0,0,16,0,0,0,2,0,13,0,0,0,14,0,12,1,18,11,0,4,0,10,7,9,0,8,0,20,1,16,21}
string picturename[] = {"Custom002!","Export!","Globals!","EditDataGrid!","Custom026!","Custom073!","Custom076!","EditDataTabular!","Custom079!","DosEdit5!","Custom083!","red_flag.bmp","Custom038!","Watcom!","Custom023!","Custom025!","ViewPainter!","Count!","DeleteWatch!","Start5!","InkEdit!"}

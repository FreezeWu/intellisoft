$PBExportHeader$w_audit_trail.srw
forward
global type w_audit_trail from pfc_w_response
end type
type st_3 from statictext within w_audit_trail
end type
type dw_select from datawindow within w_audit_trail
end type
type dw_prac_facil from datawindow within w_audit_trail
end type
type cb_close from commandbutton within w_audit_trail
end type
type dw_link_list from datawindow within w_audit_trail
end type
type dw_addresses from u_dw within w_audit_trail
end type
type tab_1 from tab within w_audit_trail
end type
...
type dw_detail from u_dw within w_audit_trail
end type
end forward
...
global w_audit_trail w_audit_trail
...
INSERT INTO pd_images 
			       ( rec_id, prac_id, facility_id, seq_no, screen_id, date_scanned, user_name, date_recieved, active_status, 
				    notes, reference_name,	tif_start_page, image_type_id,	file_name, modify_date)
        VALUES ( :ll_rec_id, :ll_prac_id, :ll_facility_id, :ll_seq_no, :ll_screen_id, :ldt_date_scanned, :ls_user_name, :ldt_date_recieved, 1,
					 'Uploaded through WebView', :ls_reference_name,	1, 	:ll_image_type_id, :ls_file_name, :ldt_modify_date);

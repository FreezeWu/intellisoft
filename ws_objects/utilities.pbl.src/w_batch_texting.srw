...
string text = "In order to send a text to a provider, you must have the mobile number (car_phone_1) as well as the Carrier.  These fields are normally found on the Personal Data screen."
boolean border = true
...
for r = 1 to rc
	...
	if res = 1 then
		...
		ls_stat = "Sent"
		//of_log_text(ls_mobile, ls_carrier, ls_text, ll_prac, )  //application function
	else
		ls_stat = "Failed"
		//of_log_text(ls_mobile, ls_carrier, ls_text, ll_prac, )  //application function
	end if

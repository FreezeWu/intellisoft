	...
	IF IsValid(w_custom_report) THEN
		...
		IF Message.StringParm = 'zero' THEN
			...
			ELSEIF is_c_alias='#invisible#' THEN //alfee 05.06.2011
				MessageBox("Info","This field cannot be added since it's invisibe in the View. Please check it in the Utilities->View Alias Maintenance and reopen the IntelliReport.")
				RETURN
			ELSE
				uf_add()
			END IF

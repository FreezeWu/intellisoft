...
type dw_detail_bg from datawindow within tabpage_browse
end type
...
type cb_show_selecttion from commandbutton within tabpage_tables
end type
...
type cb_4 from commandbutton within tabpage_tables
end type
...
type tabpage_tables from userobject within tab_1
cb_show_selecttion cb_show_selecttion
cb_15 cb_15
cb_11 cb_11
cb_10 cb_10
cb_8 cb_8
...
type cb_2 from commandbutton within tabpage_columns
end type
type cb_selecttion from commandbutton within tabpage_columns
end type
type cb_move_left from commandbutton within tabpage_columns
end type
type cb_move_right from commandbutton within tabpage_columns
end type
type dw_7 from datawindow within tabpage_columns
end type
type dw_3 from datawindow within tabpage_columns
end type
type cb_6 from commandbutton within tabpage_columns
end type
...
type dw_6 from datawindow within tabpage_filter
end type
...
type cb_18 from commandbutton within tabpage_sort
end type
...
IF Not tab_1.tabpage_tables.cbx_advanced.checked THEN
	IF tab_1.tabpage_tables.dw_view_tables.RowCount() > 1 AND tab_1.tabpage_tables.dw_view_links.RowCount() = 0  THEN
		tab_1.tabpage_tables.cb_9.event clicked()
...
public function string of_build_view_sql (integer as_flag);Integer i
Integer li_add_rec_fld  
Integer li_distinct_sql
Integer li_rc
...
for ll_i =  1 to UpperBound(tab_1.tabpage_columns.Control)
	If tab_1.tabpage_columns.Control[ll_i].ClassName() = 'dw_2' or &
		tab_1.tabpage_columns.Control[ll_i].ClassName() = 'dw_3' or &
		tab_1.tabpage_columns.Control[ll_i].ClassName() = 'dw_7' Then Continue //Added by Appeon long.zhang 03.09.2016 (BugL030902)
...
for ll_i =  1 to UpperBound(tab_1.tabpage_filter.Control)
	...
	If tab_1.tabpage_filter.Control[ll_i].ClassName() = 'dw_6' Then Continue //Added by Appeon long.zhang 03.09.2016 (BugL030902)
...
for ll_i =  1 to UpperBound(tab_1.tabpage_sort.Control)
	If tab_1.tabpage_sort.Control[ll_i].ClassName() = 'dw_4' Then Continue //Added by Appeon long.zhang 03.09.2016 (BugL030902)
...
for ll_i =  1 to UpperBound(tab_1.tabpage_tables.Control)
	If tab_1.tabpage_tables.Control[ll_i].ClassName() = 'dw_1' Then Continue //Added by Appeon long.zhang 03.09.2016 (BugL030902)
...
tab_1.tabpage_columns.dw_3.y = tab_1.tabpage_columns.dw_2.y
tab_1.tabpage_columns.dw_3.x = tab_1.tabpage_columns.dw_view_fields.x
...
tab_1.tabpage_columns.dw_7.y = tab_1.tabpage_columns.dw_view_fields.y + tab_1.tabpage_columns.dw_view_fields.height + 12
tab_1.tabpage_columns.dw_7.x = tab_1.tabpage_columns.dw_view_fields_edit.x
tab_1.tabpage_columns.dw_7.width = tab_1.tabpage_columns.dw_view_fields_edit.width
tab_1.tabpage_columns.dw_view_fields_edit.y = tab_1.tabpage_columns.dw_7.y + tab_1.tabpage_columns.dw_7.height - li_reduce
...
CHOOSE CASE newindex
	CASE 2
		...
		if il_module=2 or il_module=4 then //Bug 4300 - alfee 11.18.2014
			tab_1.tabpage_tables.cb_show_selecttion.visible=true
		end if
		//--------End Added --------------------------------------------
	CASE 3,5
		ll_Cnt = tab_1.tabpage_tables.dw_view_tables.Rowcount( )
		...
		if newindex = 3 then
			...
			//if il_module=2 then  //Start Code Change ----11.15.2010 #V10 maha - changed to show for all cred app
			if il_module=2 or il_module=4 then //Bug 4300 - alfee 11.18.2014
				tab_1.tabpage_columns.cb_selecttion.visible=true
			end if
			//--------End Added --------------------------------------------
		else
...
this.dw_detail_bg=create dw_detail_bg
...
tab_1.tabpage_tables.cb_show_selecttion.visible =(il_module = 2 or il_module = 4) //Bug 4300 - alfee 11.18.2014
tab_1.tabpage_columns.cb_selecttion.visible =(il_module = 2 or il_module = 4) //Bug 4300 - alfee 11.18.2014
//---------End Added ------------------------------------------------------------------
...
choose case dwo.name
	case "preview_type"
//		if data = '1' then
//			this.setitem(1, "auto_save" ,0)
//			this.setitem(1, "export_format" ,"")
//			this.setitem(1, "export_path" ,"")
//		end if
end choose
...
if dwo.name="b_1" then
 ...
 //Start Code Change ----07.11.2017 #V153 maha
elseif dwo.name = "b_pre_help" then
...
//End Code Change ----07.11.2017


end event

event resize;//------------------- APPEON BEGIN -------------------
...
this.cb_show_selecttion=create cb_show_selecttion
...
this.Control[]={this.cb_show_selecttion,&
this.cb_15,&
this.cb_11,&
this.cb_10,&
this.cb_8,&
...
destroy(this.cb_show_selecttion)
destroy(this.cb_15)
destroy(this.cb_11)
destroy(this.cb_10)
destroy(this.cb_8)
...
this.cb_selecttion=create cb_selecttion
...
if this.text = "Expand" then
	...
	dw_view_fields.height = tv_fields.height
	this.text = "Collapse"
else
	dw_7.visible = true
...
event retrieveend;//$<comment> 04.17.2008 by Andy
...
event rowfocuschanged;//$<add> 03.04.2008 by Andy
if CurrentRow < 1 then return
...
dw_7.Title = ls_label_text + " Column Properties"
//---------Begin Added by (Appeon)Toney 06.13.2013 for V141 ISG-CLX--------
long ll_TableID
...
event buttonclicked;//$<add> 05.16.208 by Andy
Long   ll_Pos
...
event itemchanged;//$<add> 05.16.2008 by Andy
Long   ll_Pos,ll_Find
String ls_v_name,ls_c_name

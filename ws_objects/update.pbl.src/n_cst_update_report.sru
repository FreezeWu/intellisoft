...
IF appeongetclienttype() = 'WEB' THEN 
	rpt_path = gs_dir_path + "intellicred\reports_v153.txt" 			
	wiz_path = gs_dir_path + "intellicred\report_wiz_v153.txt"		
	...
	END IF
ELSE 
	rpt_path = Gs_Current_Directory + "\reports_v153.txt"			//Start Code Change ----02.04.2010 #V10 maha	//Modified by Scofield on 2008-06-11
	wiz_path = Gs_Current_Directory + "\report_wiz_v153.txt"		//Start Code Change ----02.04.2010 #V10 maha	//Modified by Scofield on 2008-06-11
END IF
//-------End Modified --------------------------------

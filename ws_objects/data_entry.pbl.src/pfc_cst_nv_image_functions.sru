...
public function integer of_save_image_to_db (long al_rec_id, long al_prac_id, long ai_facility_id, integer ai_screen_id, long ai_seq_no)
...
ls_filename = String(al_prac_id) + "_" + String(ai_seq_no) + ".tif"
...
public function integer of_save_image_to_db (long al_rec_id, long al_prac_id, long ai_facility_id, integer ai_screen_id, long ai_seq_no);ulong l_handle
integer li_filenum, li_loops, li_counter 
long ll_filelen, ll_bytes_read, ll_new_pos 
long ll_cnt
blob lb_our_blob, lb_tot_b, blob_temp, total_blob, blank_blob 
